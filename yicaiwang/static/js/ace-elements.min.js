...
(function (e, c) {
    ...
    f.prototype.apply_settings = function () {
        ...
        this.$element.after('<label data-title="' + this.settings.btn_choose + '"><span style="color: #B94A48" data-title="' + this.settings.no_file + '">' + (this.settings.no_icon ? '<i class="' + this.settings.no_icon + '"></i>' : "") + "</span></label>" + (k ? '<a class="remove" href="#"><i class="' + this.settings.icon_remove + '"></i></a>' : ""));
